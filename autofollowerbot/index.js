...
twitterAutofollowBot.run({
  accessToken: '152919960-4FHiKrjNlR6YxlBWU3uKi35ZNC2mUP4N497bw6bj',
  accessTokenSecret: 'lpAGFMV0nWRR9nNsvDcwc8GqVCadOA2lBSIc1PbGTsZGC',
  consumerKey: 'FRUG498qis99YY06a0WY0rdnE',
  consumerSecret: 'InhnVPfKmWrUvfzPe68ERYV21IAgLqCPHDAxZviCHeoNiXTNw2'
});
...
function _fetchFollowers(nextCursor, cb) {
  twitter.get('followers/ids', {
    ...
    var followerIds = ['LegalizeCannab7'];
